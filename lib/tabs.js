    ...
    calcPaneInstances: function calcPaneInstances() {
      ...
      if (this.$slots.default) {
        var paneSlots = this.$slots.default.filter(function (vnode) {
          return vnode.tag && vnode.componentOptions && vnode.componentOptions.Ctor.options.name.includes('TabPane');
        });
        // update indeed
  ...
  render: function render(h) {
    ...
    return h(
      ...
      { 'class': [(_ref2 = {
        ...
        }, _ref2['el-tabs--' + tabPosition] = true, _ref2['el-tabs--border-card'] = type === 'border-card', _ref2), customClass] },
